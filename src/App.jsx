...
function WorkoutSession({workout,history,onFinish,onBack,startRest,restEnabled}){
  ...
  const onRepsBlur=(ei,si)=>{ const ex=workout.exercises[ei]; const r=parseInt(exStates[ei].sets[si].reps); if(!isNaN(r)&&r>0&&restEnabled)startRest(ex.rest); };
