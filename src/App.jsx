              ...
              <table className="set-table">
                ...
                <tbody>
                  {exState.sets.map((s,si)=>{
                    ...
                    return(
                      <tr key={si} className={`set-row ${s.done?"row-done":""} ${s.skipped?"row-skip":""}`}>
                        <td>
                          <div style={{display:"flex",alignItems:"center",gap:6}}>
                            <span className={`set-num-badge ${!s.done&&!s.skipped?"active":""}`}>{si+1}</span>
                            <div className="set-skip-dot" onClick={()=>toggleSetSkip(ei,si)} title="Skip set">
                              {s.skipped?"↩":"–"}
                            </div>
                          </div>
                        </td>
