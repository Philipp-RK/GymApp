...
function SetTypePicker({sets, si, onSelect}) {
  ...
  return (
    <div className="type-picker-wrap" ref={ref}>
      ...
      {open && (
        <div className="type-picker-popup" onClick={e=>e.stopPropagation()}>
          {options.map(o => (
...
function ExerciseSetTable({ ex, sets, editable=false, onTypeSelect, onWeightChange, onRepsChange, onFieldBlur, onSkip, onCheck, onAddSet }) {
  const thead = (
